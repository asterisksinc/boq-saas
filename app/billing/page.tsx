            ...
            <aside className="fig-dashboard-rail" aria-label="Dashboard navigation">
                ...
                <nav className="fig-dashboard-menu">
                    {menuRoutes.map((route, index) => (
                        <button key={route} type="button" className={index === 10 ? "is-current" : ""} aria-label={`Navigate to ${route}`} onClick={() => window.location.assign(route)}>
            ...
            <div className="fig-dashboard-main">
                ...
                <section style={{ padding: "32px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "500px" }}>
                    <div style={{ textAlign: "center", maxWidth: "480px" }}>
                        ...
                        <h2 style={{ fontSize: "24px", fontWeight: 600, color: "#1f2d3d", margin: "0 0 12px" }}>Billing & Subscription</h2>
                        ...
                        <p style={{ fontSize: "14px", color: "#9ca3af", margin: "0 0 32px" }}>
                            Manage your plan, view usage, update payment methods, and download invoices from here.
                        </p>
